...
export const VOICES: Voice[] = [
  // Female voices
  { id: 'Zephyr', name: 'Zephyr', description: '밝음 (Bright)', gender: 'female' },
  { id: 'Kore', name: 'Kore', description: '단단함 (Firm)', gender: 'female' },
  { id: 'Leda', name: 'Leda', description: '젊음 (Youthful)', gender: 'female' },
  { id: 'Aoede', name: 'Aoede', description: '산뜻함 (Breezy)', gender: 'female' },
  { id: 'Callirrhoe', name: 'Callirrhoe', description: '편안함 (Easy-going)', gender: 'female' },
  { id: 'Autonoe', name: 'Autonoe', description: '밝음 (Bright)', gender: 'female' },
  { id: 'Despina', name: 'Despina', description: '매끄러움 (Smooth)', gender: 'female' },
  { id: 'Erinome', name: 'Erinome', description: '명료함 (Clear)', gender: 'female' },
  { id: 'Laomedeia', name: 'Laomedeia', description: '경쾌함 (Upbeat)', gender: 'female' },
  { id: 'Gacrux', name: 'Gacrux', description: '성숙함 (Mature)', gender: 'female' },
  { id: 'Pulcherrima', name: 'Pulcherrima', description: '적극적임 (Forward)', gender: 'female' },
  { id: 'Vindemiatrix', name: 'Vindemiatrix', description: '온화함 (Gentle)', gender: 'female' },
  { id: 'Sulafat', name: 'Sulafat', description: '따뜻함 (Warm)', gender: 'female' },
  { id: 'Achernar', name: 'Achernar', description: '부드러움 (Soft)', gender: 'female' },
  // Male voices
  { id: 'Puck', name: 'Puck', description: '경쾌함 (Upbeat)', gender: 'male' },
  { id: 'Charon', name: 'Charon', description: '정보 전달형 (Informative)', gender: 'male' },
  { id: 'Fenrir', name: 'Fenrir', description: '흥분감 (Excitable)', gender: 'male' },
  { id: 'Orus', name: 'Orus', description: '단단함 (Firm)', gender: 'male' },
  { id: 'Enceladus', name: 'Enceladus', description: '숨소리 섞임 (Breathy)', gender: 'male' },
  { id: 'Iapetus', name: 'Iapetus', description: '명료함 (Clear)', gender: 'male' },
  { id: 'Umbriel', name: 'Umbriel', description: '편안함 (Easy-going)', gender: 'male' },
  { id: 'Algieba', name: 'Algieba', description: '매끄러움 (Smooth)', gender: 'male' },
  { id: 'Algenib', name: 'Algenib', description: '거친 음색 (Gravelly)', gender: 'male' },
  { id: 'Rasalgethi', name: 'Rasalgethi', description: '정보 전달형 (Informative)', gender: 'male' },
  { id: 'Alnilam', name: 'Alnilam', description: '단단함 (Firm)', gender: 'male' },
  { id: 'Schedar', name: 'Schedar', description: '고른 톤 (Even)', gender: 'male' },
  { id: 'Achird', name: 'Achird', description: '친근함 (Friendly)', gender: 'male' },
  { id: 'Zubenelgenubi', name: 'Zubenelgenubi', description: '일상적임 (Casual)', gender: 'male' },
  { id: 'Sadachbia', name: 'Sadachbia', description: '생동감 (Lively)', gender: 'male' },
  { id: 'Sadaltager', name: 'Sadaltager', description: '박식함 (Knowledgeable)', gender: 'male' },
];
...
export const FloppyDiskIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 8.25V6a2.25 2.25 0 00-2.25-2.25H6A2.25 2.25 0 003.75 6v8.25A2.25 2.25 0 006 16.5h2.25m8.25-8.25H6.75" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 16.5v-7.5a1.5 1.5 0 011.5-1.5h3a1.5 1.5 0 011.5 1.5v7.5" />
    </svg>
);
